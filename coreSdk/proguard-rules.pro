...
#
## virtual app
#-keep @interface com.vcore.client.hook.annotations.** {*;}
#
...
#}
#
#-keep class com.vcore.client.NativeEngine{
#    public <methods>;
#}
#
#-keep @interface com.vcore.helper.Keep {*;}
#-keep @com.vcore.helper.Keep class ** {
#    public <methods>;
#}
#
#-keepclasseswithmembernames class com.vcore.client.hook.instruments.InstrumentationProxy {*;}
#
#-keep class com.vcore.client.hiddenapibypass.** { *;}
#-keep class sun.misc.** { *;}
