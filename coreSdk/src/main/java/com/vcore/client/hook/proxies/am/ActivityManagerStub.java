...
import com.vcore.client.hook.base.BinderInvocationStub;
...
import com.vcore.client.hook.base.ReplaceLastUidMethodProxy;
...
import com.vcore.helper.compat.ParceledListSliceCompat;
            ...
            addMethodProxy(new StaticMethodProxy("getRunningTasks") {
                ...
                List<ActivityManager.RunningTaskInfo> infos =
                        ParceledListSliceCompat.isReturnParceledListSlice(method)
                                ...
                                : (List<ActivityManager.RunningTaskInfo>) _infos;
